...
(defun package-activate-1 (package pkg-vec)
  (let* ((name (symbol-name package))
    ...
    (let ((package-autoload-file (expand-file-name (concat name "-autoloads.el") pkg-dir)))
      (package-autoload-ensure-default-file package-autoload-file)
      ;;(when (file-exists-p package-autoload-file) (load (package-autoload-file) nil t))
      (load package-autoload-file nil t)
      )
