...
** Nota Bene
emacs-for-python is cool and all but in collaboration with Andreas
Roehler we are creating a new package aided to python emacs
development. PDEE (python development emacs environment) is osted here
on github at the address https://github.com/pdee/pdee .

The starting point is emacs-for-python itself and I'm developing new
features mostly there. So, for old/curent users I'm always there for
you, but if you want the package of the future go for PDEE!!!
